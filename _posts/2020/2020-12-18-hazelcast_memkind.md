...
In Memory Mode, the sytem’s DRAM behaves as a cache while PMem provides large memory capacity.
...
of accessing PMem compared to accessing DRAM. In other words, Intel Optane persistent memory’s features
can help it outperform a DRAM-only system when operating in a distributed environment.
